...
label fifthAct:
    ...
    Todd "У меня не очень, а вот у Брайна точно всё получилось. За время {a=glossary:Делёжка}\"Делёжки\"{/a} он поработал почти на все крупные фирмы континента и всех успешно кинул: кого-то обокрал, кого-то сдал другим, некоторых может контролировать. Или мог до недавнего времени."
...
label sixthAct:
    ...
    Mira "Молодец, нам хоть жить проще будет."
    ...
    Urgen "Его искать не пришлось. Как только я ушёл, он меня встретил и сказал, что не вернётся, пока не искупит вину перед Тоддом и Мирой."
...
label startSeventhMiniGame:
    ...
    "Какая переменная может отвечать за базу?"
...
label startEighthMiniGame:
    ...
    "Где же может быть ключ доступа?"
