...
label secondAct:
    ...
    Urgen "Без тебя вижу. Твой \"хороший профессионал\" решил нас кинуть и достал нам {a=glossary:Образ}образ{/a} какого-то идиота."
...
label fourthAct:
    ...
    Todd "Наш доблестный командир хочет выставить все их грязные секретики на всемирное обозрение, {w}возможно, желая освободить континент от фирм, и сделать его снова свободным."
    ...
    Todd "Хорош, оно работает. Может Юрген ошибается, ты и, правда, тот, кто нам нужен?"
    ...
    ggDenis "Но как это использовать? Скажем так, как сделать запрос?"
...
label fifthAct:
    ...
    Urgen "Да пошёл он."
    Murus "Я так же подумал и ничего не сказал. {w}Тодд, прости меня, нельзя было не подключать этого робота, они бы проверили и тогда пришли бы уже лично. {w}Как сейчас…"
...
label firstToddStory:
    ...
    ggDenis "Да, он. А что?"
    Todd "Да так, ничего. {w}Просто не верь всему, что он говорит, часто ты видишь неполную картину событий."
