            ...
            vbox:
                ...
                if persistent.dict0:
                    hbox:
                        text "Имплант"
                        null width 10
                        text "--> История первых имплантов уходит в далёкий 20-й век, когда их использовали в медицинских целях. Широкое распространение они получили в 21 веке после появления новой сети. Импланты позволяли проводить больше времени в виртуальном пространстве без пагубных последствий для организма, восстанавливать и заменять органы. К началу 22 века они стали неотъемлемой частью жизни любого современного человека, позволяя каждому улучшать возможности своего тела, продлевать жизнь и совершенстваться на работе, где кратно увеличивали работоспособность, выносливость и количество полезного труда."
                if persistent.dict1:
                    hbox:
                        text "Сетевик"
                        null width 10
                        text "--> Если сверяться с Словарём Новейшего времени, то термином “сетевик” можно назвать любого пользователя Новой сети, однако в большинстве случаев “сетевик” – термин, обозначающий человека, профессионально работающего в новом информационном пространстве, а именно выполняющим функции нахождения, обработки, хранения и защиты информации."
                if persistent.dict2:
                    hbox:
                        text "Team\nNew\nNet"
                        null width 10
                        text "\n\n--> Изначально TNN было известно, как объединение авантюристов, поставивших перед собой цель создания новой сети с упрощённым доступом к информации в объёмном виртуальном пространстве. После представления ранней версии в 2038 году TNN получило финансирование от ряда крупных компаний с условием их частного пользования будущим продуктом. Однако в 2039 году рабочая версия новой сети появилась в общем доступе. После ряда независимых расследований, было выяснено, что TNN намеренно нарушили предписанные ранее соглашения, а после скрылись. Объединение TNN было признано экстремистким, их контролируемый слив новой сети был воспринят, как попытка подрыва мировой логистики и международных взаимоотношений. Как стало известно позже, TNN перешло в подполье, откуда бывшие сотрудники продолжали дорабатывать сеть, сделав её универсальным инструментом с почти безграничными возможностями для персонализации.\n\"Вырезка из статьи от 2099 года, приуроченной к юбилею выхода Сети\"."
                if persistent.dict3:
                    hbox:
                        text "Образ"
                        null width 10
                        text "--> Представляет собой результат работы программы по переносу личности в виртуальное пространство.\nРанняя разработка данной программы велась с 2040 года, как необходимость для комфортного использования новой сети. Впоследствии стала неотъемлемой частью пользовательского интерфейса, позволяющей создавать временную копию личности человека при каждом его подключении."
                if persistent.dict4:
                    hbox:
                        text "Univency"
                        null width 10
                        text "--> После окончания Третей мировой войны появилась необходимость в появлении международной валюты. На территориях, подконтрольных крупным компаниям, действует валюта \"Univency\" от \"universal\" и  \"value\"."
                if persistent.dict5:
                    hbox:
                        text "Офисник"
                        null width 10
                        text "--> С появлением новой сети у крупный компаний возникла необходимость в переносе, реструктуризации, защите информации в новом цифровом пространстве. В результате появилось большое количество выгодных вакансий для людей, что уже успели изучить возможности новой сети."
                if persistent.dict6:
                    hbox:
                        text "Newborn\nOld\nWorld"
                        null width 10
                        text "\n\n--> Содружество \"Newborn Old World\" было образовано в конце 2137 года после пятилетнего периода \"Делёжки\" в него вошли крупнейшие, на тот момент времени, фирмы, победившие в территориальном конфликте с целью согласования границ, а после и внешней политики на всём континенте."
                if persistent.dict7:
                    hbox:
                        text "Делёжка"
                        null width 10
                        text "--> После Третьей мировой войны территорию Евразии стали контролировать крупные фирмы, между которыми начался раздел подконтрольных территорий. В этот момент на континенте начинают появляться крупные вооружённые содружества, ставящие своей целью освобождение территорий бывших стран и свержение фирм – гегемонов. В ходе пятилетней борьбы повстанческие объединения потерпели поражение: часть была подчинена фирмами, прочие либо ушли в подполье, либо перебрались через море, где смогли освободить Южную Америку."
